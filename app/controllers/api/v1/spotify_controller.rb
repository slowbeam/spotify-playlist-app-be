class Api::V1::SpotifyController < ApplicationController
  ...
  def search
    ...
    case @mood
      when 'sad'
        redirect_to "http://vibelist.co/create-sad-vibelist?" + response_query_data.to_query
      when 'content'
        redirect_to "http://vibelist.co/create-content-vibelist?" + response_query_data.to_query
      when 'ecstatic'
        redirect_to "http://vibelist.co/create-ecstatic-vibelist?" + response_query_data.to_query
    end
  ...
  def create_playlist
    ...
    case current_mood
      when 'sad'
        redirect_to "http://vibelist.co/create-sad-vibelist?mood=" + current_mood +
        "&uri=" + @playlist_uri
      when 'content'
        redirect_to "http://vibelist.co/create-content-vibelist?mood=" + current_mood + "&uri=" + @playlist_uri
      when 'ecstatic'
        redirect_to "http://vibelist.co/create-ecstatic-vibelist?mood=" + current_mood + "&uri=" + @playlist_uri
    end
